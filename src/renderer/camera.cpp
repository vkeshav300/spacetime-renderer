...
matrix_float4x4 Camera::get_camera_matrix4x4(const float aspect_ratio) {
  const matrix_float4x4 perspective_projection_matrix =
                            apple_math::make_perspective_projection_matrix4x4(
                                m_fov, aspect_ratio, m_near_z, m_far_z),
                        view_matrix = apple_math::make_look_at_matrix4x4(
                            m_position, m_target);
